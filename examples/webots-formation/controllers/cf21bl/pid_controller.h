 ...
 *
 * Vendored unmodified from Webots' bundled reference controller
 * (projects/robots/bitcraze/crazyflie/controllers/crazyflie/pid_controller.h,
 * Webots R2025a) for use as this example's L1 attitude/velocity/altitude
 * control loop — see substrate_webots.c. Apache-2.0, same license as
 * Tapestry itself.
 */
