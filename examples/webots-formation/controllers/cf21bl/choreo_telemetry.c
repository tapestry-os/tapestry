...
choreo_telemetry_t *choreo_telemetry_open(element_id_t element_id)
{
    ...
    fprintf(f, "tick,wall_time_s,element_id,pos_x,pos_y,pos_z,"
 ...
 * class docstring): id, x, y, z, is_active, is_stale, is_self, achieved.
 *
